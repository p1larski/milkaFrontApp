       ...
       <h1>Brak danych</h1>
            ...
            {/* View Modal */}
                ...
                >
                    <Button variant='secondary'
                                ...
                                onClick={ () => {hanldeViewClose(); GetEmployeeData()}}>
                                                Zamknij
                        </Button>
                    ...
                    <Modal.Body>
                        <div className='viewDisplay'>
                            ...
                            <p></p>
                                    <Button className='buttonAction' 
                                            variant='secondary' 
                                            onClick={()=> {handleEditShow(SetRowData(day),
                                                                            setId(day.id)); hanldeViewClose()}}>
                                                    Zmień godziny
                                    </Button>
                                    <p></p>
                                    <Button className='buttonAction' 
                                            variant='secondary' 
                                            onClick={()=> {handleReservationShow(sethoursOfDay(hoursOfDay)); hanldeViewClose()}}>
                                                    Rezerwacja wizyty
                                    </Button>
                                    <p></p>
                                    <Button className='buttonAction' 
            ...
            {/* Modal for submit data to database */}
                ...
                >
                    <Button variant='secondary' 
                            className='buttonAction'
                            onClick={() => {hanldePostClose(); GetEmployeeData()}}>
                                            Zamknij
                    </Button>
                    <div class='modal-dialog' role='document'>
                            <div class='modal-content'>
            ...
            {/* Modal for Edit employee record */}
                ...
                <Button variant='secondary'
                        className='buttonAction' 
                        onClick={() => {hanldeEditClose(); GetEmployeeData()}}>
                                        Zamknij
                </Button>
                        <div class='modal-dialog' role='document'>
                            <div class='modal-content'>
                ...
                <Modal show={ViewHours}
                        ...
                        scrollable = {true}>   
                                ...
                                <Button variant='secondary'
                                        className='buttonAction' 
                                        onClick={() => {handleHoursClose(); GetEmployeeData()}}>
                                                        Zamknij
                                </Button>
                ...
                <Modal show={ViewReservation}
                    ...
                    <Button variant='secondary' 
                            className='buttonAction'
                            onClick={() => {handleReservationClose(); GetEmployeeData()}}>
                                            Zamknij
                    </Button>
                    <div class='modal-dialog' role='document'>
                            <div class='modal-content'>
